<?php if ( !defined('BASEPATH') )exit('No direct script access allowed');?>
        ...
        <div class="container-fluid">
            <div class="block-header">
                <ol class="breadcrumb breadcrumb-bg-teal">
					...
					<li class="active"><a href="javascript:void(0);"><i class="material-icons">content_copy</i> Template Venue</a></li>
				</ol>
            </div>
														...
														<td>
															<div class=\"btn-group\">
																...
																<ul class=\"dropdown-menu\">
																	<li><a href=\"javascript:void(0);\" class=\"btn-edit waves-effect waves-block\" tag-id=\"{$row->tv_id}\"><i class=\"material-icons\">create</i> Edit</a></li>
																	<li><a href=\"javascript:void(0);\" class=\"btn-remove waves-effect waves-block\" tag-id=\"{$row->tv_id}\"><i class=\"material-icons\">clear</i> Remove</a></li>
																</ul>
															</div>
														</td>
													</tr>
			...
			<form method="POST" id="default-form" enctype="multipart/form-data">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="defaultModalLabel">Template Venue</h4>
					</div>
					<div class="modal-body">
						<div class="row clearfix">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">								
								<div class="form-group">
									<div class="form-line">
										<textarea name="temp_content" style="resize:none;" rows="5" id="temp_content" class="form-control" placeholder="Template content *" maxlength="500" required></textarea>
									</div>							
								</div>
							</div>
						</div>			
	...
	<script src="<?php echo base_url()?>media/backend/js/pages/template/template-venue.js"></script>
