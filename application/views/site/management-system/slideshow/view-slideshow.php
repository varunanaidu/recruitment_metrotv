<?php if ( !defined('BASEPATH') )exit('No direct script access allowed');?>
        ...
        <div class="container-fluid">
            <div class="block-header">
                <ol class="breadcrumb breadcrumb-bg-teal">
					...
					<li class="active"><a href="javascript:void(0);"><i class="material-icons">photo_library</i> Slideshow</a></li>
				</ol>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<button type="button" class="btn btn-primary pull-right waves-effect" id="btn-add">New Slideshow</button>
								</div>
							</div>
								...
								<table class="table table-bordered table-striped table-hover js-basic-example dataTable">
									...
									<?php
										if ( isset($data) and $data != '0' ){
											$no = 1;
											foreach($data as $row){
												$content = strlen($row->slideshow_text) >= 30 ? substr($row->slideshow_text, 0, 30)."..." : $row->slideshow_text;
												echo "
													<tr>
														<td>{$no}</td>
														<td>{$row->slideshow_text}</td>
														<td>
															<div class=\"btn-group\">
																...
																<ul class=\"dropdown-menu\">
																	<li><a href=\"javascript:void(0);\" class=\"btn-edit waves-effect waves-block\" attr-data=\"{$row->slideshow_id}\"><i class=\"material-icons\">create</i> Edit</a></li>
																	<li><a href=\"javascript:void(0);\" class=\"btn-remove waves-effect waves-block\" attr-data=\"{$row->slideshow_id}\"><i class=\"material-icons\">clear</i> Remove</a></li>
																</ul>
															</div>
														</td>
													</tr>
			...
			<form method="POST" id="default-form" enctype="multipart/form-data">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="defaultModalLabel">Slideshow</h4>
					</div>
						...
						<div class="row clearfix">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">								
								<div class="form-group">
									<div class="form-line">
										<input type="text" id="text_slide" name="text_slide" class="form-control" placeholder="Slideshow Text *" maxlength="250" required>
									</div>							
								</div>
							</div>
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">								
								<div class="form-group">
									<div class="form-line">
										<input type="file" id="file" name="file" class="form-control" accept=".jpeg, .jpg, .png">
										<small style="color:red;">Maximum image upload 200 Kb, only allowed *.jpg, *.png types, Best Preview 1200 x 560 pixels and above</small>
									</div>							
								</div>
							</div>
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse" id="content-img">								
	...
	<script src="<?php echo base_url()?>media/backend/js/pages/slideshow/slideshow.js"></script>
