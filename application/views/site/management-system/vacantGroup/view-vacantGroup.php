	...
	<section class="content">
        <div class="container-fluid">
			...
			<ol class="breadcrumb breadcrumb-bg-teal">
				<li class="active"><a href="javascript:void(0);"><i class="material-icons">computer</i> Vacancy Group</a></li>
			</ol>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<button type="button" class="btn btn-primary pull-right waves-effect" id="btn-add">New Vacant Group</button>
								</div>
							</div>
														...
														<td>
															<div class=\"btn-group\">
																...
																<ul class=\"dropdown-menu\">
																	<li><a href=\"javascript:void(0);\" class=\"btn-edit waves-effect waves-block\" tag-id=\"{$row->vacant_group_id}\"><i class=\"material-icons\">create</i> Edit</a></li>
																	<li><a href=\"javascript:void(0);\" class=\"btn-remove waves-effect waves-block\" tag-id=\"{$row->vacant_group_id}\"><i class=\"material-icons\">clear</i> Remove</a></li>
																</ul>
															</div>
														</td>
													</tr>
			...
			<form method="POST" id="default-form" enctype="multipart/form-data">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="defaultModalLabel">Vacant Group</h4>
					</div>
					<div class="modal-body">
					<div class="row clearfix">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<label for="v_unit_id">Vacant Unit</label>
							<div class="form-group">
								<div class="form-line">
									<select class="form-control show-tick required" id="v_unit_id" name="v_unit_id" required>
									</select>
								</div>							
							</div>
						</div>
						<div class="col-lg-6 col-md-4 col-sm-6 col-xs-12">
							<label>Vacant Group</label>
							<div class="form-group">
								<div class="form-line">
										<input type="text" id="vacant_group_name" name="vacant_group_name" class="form-control" placeholder="Vacant Group Name *" maxlength="150" required>
									</div>
							</div>
						</div>
...
<script src="<?php echo base_url()?>media/backend/plugins/jquery-validation/jquery.validate.js"></script>
	...
	<script src="<?php echo base_url()?>media/backend/js/pages/vacant_group/vacant_group.js"></script>
