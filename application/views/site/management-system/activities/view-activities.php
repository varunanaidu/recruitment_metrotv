	...
	<div class="container-fluid">
		<div class="block-header">
			<ol class="breadcrumb breadcrumb-bg-teal">
				...
				<li class="active"><a href="javascript:void(0);"><i class="material-icons">photo_library</i> Activities</a></li>
			</ol>
		</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="body">
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<button type="button" class="btn btn-primary pull-right waves-effect" id="btn-add">New Activities</button>
							</div>
						</div>
								...
								<tbody>
									...
									if ( isset($data) and $data != '0' ){
										...
										foreach($data as $row){
											...
											<li><a href=\"javascript:void(0);\" class=\"btn-edit waves-effect waves-block\" attr-data=\"{$row->activity_id}\"><i class=\"material-icons\">create</i> Edit</a></li>
											<li><a href=\"javascript:void(0);\" class=\"btn-remove waves-effect waves-block\" attr-data=\"{$row->activity_id}\"><i class=\"material-icons\">clear</i> Remove</a></li>
											</ul>
											</div>
											</td>
											</tr>
		...
		<form method="POST" id="default-form" enctype="multipart/form-data">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="defaultModalLabel">Activity</h4>
				</div>
				<div class="modal-body">
					<div class="row clearfix">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">		
							...
							<div class="form-group">
								<div class="form-line">
									<input type="text" id="a_title" name="a_title" class="form-control" placeholder="Enter Activity Title" required>
								</div>							
							</div>
						</div>
					</div>
					<div class="row clearfix">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">		
							<label>Date</label>
							<div class="form-group">
								<input type="date" name="activity_date" id="activity_date" class="form-control dpicker" placeholder="Choose Date" />
							</div>
						</div>
					</div>
					<div class="row clearfix">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">		
							...
							<div class="form-group">
								<div class="form-line">
									<input type="file" id="activity_file" name="activity_file" class="form-control" accept=".jpeg, .jpg, .png, .mp4">
					...
					<label for="activity_content">Content</label>
					<div class="form-group">
						<div class="form-line">
							<textarea id="activity_content" name="activity_content" required></textarea>
						</div>
					</div>	
				</div>
...
<script src="<?php echo base_url()?>media/backend/js/pages/activities/activities.js"></script>
