<?php if ( !defined('BASEPATH') )exit('No direct script access allowed');?>
        ...
        <div class="container-fluid">
            <div class="block-header">
                <ol class="breadcrumb breadcrumb-bg-teal">
					...
					<li class="active"><a href="javascript:void(0);"><i class="material-icons">account_balance</i> University</a></li>
				</ol>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<button type="button" class="btn btn-primary pull-right waves-effect" id="btn-add">New University</button>
								</div>
							</div>
														...
														<td>
															<div class=\"btn-group\">
																...
																<ul class=\"dropdown-menu\">
																	<li><a href=\"javascript:void(0);\" class=\"btn-edit waves-effect waves-block\" tag-id=\"{$row->university_id}\"><i class=\"material-icons\">create</i> Edit</a></li>
																	<li><a href=\"javascript:void(0);\" class=\"btn-remove waves-effect waves-block\" tag-id=\"{$row->university_id}\"><i class=\"material-icons\">clear</i> Remove</a></li>
																</ul>
															</div>
														</td>
													</tr>
			...
			<form method="POST" id="default-form" enctype="multipart/form-data">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="defaultModalLabel">University</h4>
					</div>
						...
						<div class="row clearfix">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">								
								<div class="form-group">
									<div class="form-line">
										<input type="text" id="univ_name" name="univ_name" class="form-control" placeholder="University Name *" maxlength="150" required>
									</div>							
								</div>
							</div>							
						</div>			
	...
	<script src="<?php echo base_url()?>media/backend/js/pages/university/university.js"></script>
