...
?>
        ...
        <div class="container-fluid">
            <div class="block-header">
                <ol class="breadcrumb breadcrumb-bg-teal">
					...
					<li class="active"><a href="javascript:void(0);"><i class="material-icons">settings</i> Manage</a></li>
				</ol>
            </div>
												...
												<?php
													if ( isset($data_vacant) and $data_vacant != '0' ){
														foreach($data_vacant as $row){
															...
															echo "<option value=\"{$row->vacant_id}\" {$selected}>{$row->vacant_title} ({$row->a} s/d {$row->b}) - {$row->total_candidat} Applicants (".ucwords(strtolower($row->c)).")</option>";
														}
													}
												?>
											</select>
	...
	<script src="<?php echo base_url()?>media/backend/js/pages/applicant/applicant.js?v=20190614"></script>
    <!-- Demo Js -->
